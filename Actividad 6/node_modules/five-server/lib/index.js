    ...
    async start(options = {}) {
        ...
        */
        ...
        for (const [ROUTE, TARGET] of Object.entries(mount)) {
            ...
            app.use(R, (0, injectCode_1.injectCode)(mountPath, baseURL, PHP, injectBody || false, cache));
        ...
        const injectHandler = (0, injectCode_1.injectCode)(root, baseURL, PHP, injectBody || false, cache);
        ...
        if (_https !== null && _https !== false) {
            ...
            if (_https === true) {
                const fakeCert = await (0, getCertificate_1.getCertificate)(path_1.default.join(workspace ? workspace : path_1.default.resolve(), '.cache'));
