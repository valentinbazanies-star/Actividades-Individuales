...
export declare const proxyMiddleware: (options: ProxyMiddlewareOptions, baseURL: string, injectBody: boolean, enableCache: boolean) => (req: RequestWithRetry, res: Response, next: NextFunction) => Promise<void>;
export {};
